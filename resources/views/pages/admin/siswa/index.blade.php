...
<div class="d-flex justify-content-between">
    ...
    <form action="{{url('siswa')}}" method="GET" class="form-inline my-2 my-lg-0">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <table border="0">
                            ...
                            <td width="70%"><input type="text" name="kode_siswa" class="form-control" id="kode_siswa" aria-describedby="kode_siswa"></td>
                            </tr>
                            <tr>
                            <tr>
                              <td width="30%"><label>Nama</label></td>
                              <td width="70%" colspan="4"><input type="text" name="nama_siswa" class="form-control" id="nama" aria-describedby="nama" required></td> 
                            </tr>
                            <tr>
...
<!-- Modal View -->
  <div class="modal fade" id="viewsiswa" tabindex="-1" aria-labelledby="viewaminLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="viewaminLabel">Data Siswa</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                      ...
                      <table border="0">
                          @foreach ($siswa as $item)
                            <tr>
                              <td width="30%"><label>Kode</label></td>
                              <td width="2%">:</td>
                              <td width="30%">{{$item->kode_siswa}}</td>
                            ...
                            <tr>
                              <td width="30%"><label>Nama</label></td>
                              <td width="2%">:</td>
                              <td width="30%">{{$item->nama_siswa}}</td>
                            </tr>
                            <tr>
                              <td width="30%"><label>Tempat Lahir</label></td>
                              <td width="2%">:</td>
...
<!-- Modal Edit -->
   <div class="modal fade" id="editsiswa{{$item->kode_siswa}}" tabindex="-1" aria-labelledby="editsiswaLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
              ...
              <input type="hidden" name="_method" value="PATCH">
                <div class="modal-body">
                    ...
                    <table border="0">
                            <tr>
                            <td width="30%"><label>Kode</label></td>
                            <td width="70%"><input type="text" name="kode_siswa" class="form-control" id="kode_siswa" aria-describedby="kode_siswa" value="{{$item->kode_siswa}}" readonly></td>
                            </tr>
                            <tr>
                            <tr>
                              <td width="30%"><label>Nama</label></td>
                              <td width="70%" colspan="4"><input type="text" name="nama" class="form-control" id="nama" aria-describedby="nama" value="{{$item->nama_siswa}}"></td> 
                            </tr>
                            <tr>
                            <td width="30%"><label>NTA</label></td>
